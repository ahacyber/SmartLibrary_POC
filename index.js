import * as THREE from '../SmartLibrary_POC/build/three.module.js';
import { OrbitControls } from "../SmartLibrary_POC/examples/jsm/controls/OrbitControls.js"
import { GLTFLoader } from "../SmartLibrary_POC/examples/jsm/loaders/GLTFLoader.js"
import Stats from "../SmartLibrary_POC/examples/jsm/libs/stats.module.js";

import { Octree } from "../SmartLibrary_POC/examples/jsm/math/Octree.js"
import { Capsule } from "../SmartLibrary_POC/examples/jsm/math/Capsule.js"
...
class App {
    ...
    _setupModel() {
        ...
        loader.load("../SmartLibrary_POC/data/aj_character05.glb", (gltf) => {
        ...
        loader.load("../SmartLibrary_POC/data/SmartLibrary02.glb", (gltf) => {
            const model = gltf.scene;
